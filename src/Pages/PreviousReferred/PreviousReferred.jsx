...
const PreviousReferred = () => {
    return (
        <div>
            <div className="mb-4 p-6 mt-10 text-center">
                <h1 className="text-5xl font-semibold text-gray-800 mb-6">Your Previous Referred Clients</h1>
                <p className="text-gray-600">Find your Previous Referred Clients here.</p>
