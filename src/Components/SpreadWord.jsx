        ...
        <div className='bg-purple-200 py-10 rounded-2xl'>
            <div className='flex flex-col md:flex-row gap-10 px-20 items-center'>
                <div className='w-full md:w-1/2'>
                    ...
                    <p className='my-6 text-sm text-gray-500'>Your referral can make a significant difference in someone’s life. Help us build a stronger, more supportive community by referring someone today.</p>
